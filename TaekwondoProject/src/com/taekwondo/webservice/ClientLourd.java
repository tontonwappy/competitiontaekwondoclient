...
public interface ClientLourd {  
 ...
 @WebMethod public void ajoutCompetiteur(String nomCompetition, String nomClub, String nomCompetiteur, String prenomCompetiteur, int ageCompetiteur, String genre); 
 @WebMethod public void ajoutBddCategorie(String nomCompetition,String nomcategorie,int ageMini, int ageMaxi);
