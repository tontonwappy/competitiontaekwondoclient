...
@XmlRootElement(name = "recuperationTOUTCompetiteurTResponse", namespace = "http://webservice.taekwondo.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "recuperationTOUTCompetiteurTResponse", namespace = "http://webservice.taekwondo.com/")
public class RecuperationTOUTCompetiteurTResponse {
